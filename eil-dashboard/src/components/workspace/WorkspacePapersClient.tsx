...
export default function WorkspacePapersClient() {
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-5">
      ...
      {drilldown.active ? (
        <section className="rounded-xl border border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-800 dark:border-sky-900/60 dark:bg-sky-950/30 dark:text-sky-200">
