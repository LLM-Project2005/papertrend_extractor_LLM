...
const SETTINGS_SECTIONS = [
  {
    id: "general",
    label: "General",
    description: "Project name, domain, and identity.",
  },
  {
    id: "project",
    label: "Project",
  ...
  },
  {
    id: "access",
    label: "Access",
    description: "Account and synced project state.",
  },
] as const;
...
export default function WorkspaceSettingsClient() {
  ...
  const [message, setMessage] = useState<string | null>(null);
    ...
    function setSavedMessage(nextMessage = "Project preferences updated.") {
            ...
            <section className="overflow-hidden rounded-[24px] border border-slate-200 bg-white dark:border-[#1f1f1f] dark:bg-[#050505]">
              <div className="border-b border-slate-200 px-6 py-5 dark:border-[#1f1f1f]">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-[#8f8f8f]">
                  General configuration, naming, and project framing.
                </p>
              </div>
              ...
              <div className="divide-y divide-slate-200 dark:divide-[#2c2c2c]">
                <label className="grid gap-3 px-6 py-5 md:grid-cols-[220px_minmax(0,1fr)] md:items-start">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500 dark:text-[#8f8f8f]">
                      Displayed across the project shell.
                    </p>
                  </div>
                  <input
                    value={profile.name}
                ...
                <label className="grid gap-3 px-6 py-5 md:grid-cols-[220px_minmax(0,1fr)] md:items-start">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500 dark:text-[#8f8f8f]">
                      Used in the landing, project, and chat framing.
                    </p>
                  </div>
                  <input
            ...
            <section className="overflow-hidden rounded-[24px] border border-slate-200 bg-white dark:border-[#1f1f1f] dark:bg-[#050505]">
              <div className="flex items-center justify-between gap-4 px-6 py-5">
                ...
                <button
                  ...
                  onClick={() => {
                    resetProfile();
                    setSavedMessage("Project preferences reset to defaults.");
                  }}
          ...
          <>
            <section className="overflow-hidden rounded-[24px] border border-slate-200 bg-white dark:border-[#1f1f1f] dark:bg-[#050505]">
              <div className="border-b border-slate-200 px-6 py-5 dark:border-[#1f1f1f]">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-[#8f8f8f]">
                  Set the default analysis mode this project should optimize for.
                </p>
              </div>
            ...
            <section className="overflow-hidden rounded-[24px] border border-slate-200 bg-white dark:border-[#1f1f1f] dark:bg-[#050505]">
              <div className="border-b border-slate-200 px-6 py-5 dark:border-[#1f1f1f]">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-[#8f8f8f]">
                  Highlight the experiences this project should prioritize.
                </p>
              </div>
          ...
          <>
            <section className="overflow-hidden rounded-[24px] border border-slate-200 bg-white dark:border-[#1f1f1f] dark:bg-[#050505]">
              <div className="border-b border-slate-200 px-6 py-5 dark:border-[#1f1f1f]">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-[#8f8f8f]">
                  Who this project belongs to and how the profile is being remembered.
                </p>
              </div>
              ...
              <div className="divide-y divide-slate-200 dark:divide-[#2c2c2c]">
                <div className="grid gap-3 px-6 py-5 md:grid-cols-[220px_minmax(0,1fr)]">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500 dark:text-[#8f8f8f]">
                      Active account linked to this project.
                    </p>
                  </div>
