    ...
    <div className="min-w-0">
      ...
      <div className="flex min-w-0 items-center gap-2 text-sm text-slate-500 dark:text-[#9b9b9b]">
        <Link
          ...
          className="-my-2 flex flex-none items-center rounded px-1 py-2 font-medium text-slate-700 transition-colors hover:text-slate-900 dark:text-[#d9d9d9] dark:hover:text-white"
        >
