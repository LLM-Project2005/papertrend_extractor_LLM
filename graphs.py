...
def build_ingestion_graph():
    ...
    workflow.add_node("author_keywords", extract_author_keywords_node)
    ...
    workflow.add_edge("metadata", "author_keywords")
    workflow.add_edge("author_keywords", "mine_keywords")
